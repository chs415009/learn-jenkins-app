pipeline {
    ...
    stages {
        ...
        stage('Deploy to AWS') {
            ...
            // environment {
            //     AWS_S3_BUCKET = 'learn-jenkins-202505301409'
            // }
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'my-aws', passwordVariable: 'AWS_SECRET_ACCESS_KEY', usernameVariable: 'AWS_ACCESS_KEY_ID')]) {
                    sh '''
                        ...
                        aws ecs update-service --cluster LearnJenkinsApp-Cluster-Prod --service earnJenkinsApp-Service-Prod --task-definition earnJenkinsApp-TaskDefinition-Prod:2
                    '''
                }                
            }
        }
